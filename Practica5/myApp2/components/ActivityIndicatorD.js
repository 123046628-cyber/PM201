...
export default function ActivityIndicatorD(){
    ...
    return(
        <View style={styles.container}>
            ...
            <Text style={styles.descripcion}> 
                ...
                Tambien se puede usar para cambiar el tamaño "size" y el color.
            </Text>

            <Button title='Mostrar/Ocultar Spinner' onPress={() => setLoading((estadoActual) => !estadoActual)} />
